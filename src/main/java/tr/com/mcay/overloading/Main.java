...
public class Main {
    public static void main(String[] args) {
        ...
        Student student2 = new Student("Murat", "Kaya", 20230001);
// constructors to objects can be defined as many as needed


        student1.setGrades(50, 70);
        student2.setGrades(80, 90);
        student1.calculateMeanGrade();
